import { KeySquareIcon, LockIcon, LogInIcon, MailIcon, MoveLeftIcon } from "lucide-react"
    ...
    return (
        <section className="flex flex-col w-full min-h-dvh p-3">
            ...
            <article className="space-y-7 max-w-4xl mx-auto">
                ...
                <form className="flex flex-col items-center text-sm border rounded-xl border-gray-300 px-6 py-5 gap-4">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="relative w-full">
                            ...
                            <input type="password" placeholder="••••••••" className="py-2 px-9 border border-gray-200 rounded-full w-md hover:border-[#3b5a42] transition-colors duration-200 focus:border-[#03a941] focus:ring-2 focus:ring-[#03a941]/20 outline-none text-sm bg-white" />
                        </div>
                    </div>
                    ...
                    <button type="submit" className="flex items-center justify-center gap-2 w-full py-2 rounded-lg bg-[#03a741] text-white font-bold hover:bg-[#029436] transition-colors duration-200 text-sm"><LogInIcon className="size-4"/>
                        Iniciar sesión
                    </button>
                    <div className="flex items-center w-full">
                        <div className="grow border-t border-gray-400"></div>
                        <span className="mx-4 text-xs text-gray-600">¿No tienes cuenta?</span>
                        <div className="grow border-t border-gray-400"></div>
                    </div>
                    <Link to="/register" className="flex items-center justify-center gap-2 w-full border border-gray-300 rounded-lg py-2 text-sm font-bold hover:text-[#03a741] transition-colors duration-200" href=""><KeySquareIcon className="size-4" />Crear una cuenta</Link>
                </form>
            </article>
        </section>
    )
